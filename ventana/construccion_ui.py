...
class ConstruccionUI:
    ...
    def create_menus(self):
        ...
        acciones_capas = [
            ...
            ("new_visible", t("menu.layers.new_from_visible"), ":/icons/layer_new_visible.png", "", self.layer_new_from_visible),
            ...
            None,
            ("copy_visible", t("menu.layers.copy_visible"), ":/icons/layer_copy_visible.png", "", self.layer_copy_visible),
            ("alpha_selection", t("menu.layers.alpha_to_selection"), ":/icons/layer_alpha_select.png", "", self.layer_alpha_to_selection),
            None,
            ...
            ("crop_content", t("menu.layers.crop_to_content"), ":/icons/layer_crop_content.png", "", self.layer_crop_to_content),
            None,
            ...
            None,
            ("center",     t("menu.layers.center"),          ":/icons/layer_center.png", "", self.layer_center),
        ...
        mask_entries = [
            ...
            None,
            ("mask_invert",   t("menu.layers.mask.invert"),  ":/icons/invert.png",        lambda: self.layer_mask_invert()),
        ...
        if QFile.exists(":/icons/layer_clip.png"):
            self.clip_action.setIcon(theme.icono(":/icons/layer_clip.png"))
